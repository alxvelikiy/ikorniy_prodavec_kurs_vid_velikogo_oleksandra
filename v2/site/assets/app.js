...
(function () {
  ...
  function renderRing(svg) {
    ...
    // кольори — токени --ring-fill / --ring-track (assets/tokens.css), однаково для світлої і темної теми
    var color = 'var(--ring-fill)';
    var inactive = 'var(--ring-track)';
    ...
    for (var i = 0; i < total; i++) {
      ...
      c.style.fill = i < active ? color : inactive;
      frag.appendChild(c);
    }
